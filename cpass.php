...
$r_email = $_SESSION['r_email'];
  ...
  echo "<script>location.href='companylogin.html'</script>";
}
$sql = "SELECT r_password, r_email  FROM companyregister_tb WHERE r_email = '$r_email'";
...
if(isset($_REQUEST['passcng'])){
  if(($_REQUEST['r_password'] == "")){
   ...
   $sql = "UPDATE companyregister_tb SET r_password = '$r_password' WHERE r_email = '$r_email'";
...
<li class="nav-item"><a class="nav-link" href="criteria.php"><i class="fas fa-key"></i>Company Criteria </a></li>
...
<form action="" method="POST" class="ms">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" name="r_password" id="r_password" value="<?php echo $r_password ?>" >
    </div>
