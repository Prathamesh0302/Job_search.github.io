...
if($_SESSION['is_adminlogin']){
    ...
    $selectquery="select * from criteria_tb";
...
<div class="card">
    ...
    <a href="dashboard.php" class="btn btn-light">Go Back</a>
             ...
             <div class="col-md-3" ><h3>Job Requirement Details</h23></div>
     ...
     <tr>
        ...
        ?>
           <tr>
                ...
                <td><?php echo $res['c_name_tb']; ?></td>
                <td><?php echo $res['c_role_tb']; ?></td> 
                <td><?php echo $res['c_edu_tb'];?></td>
                <td><?php echo $res['c_per_tb'];?></td>
                <td><?php echo $res['c_sal_tb']; ?></td>
                <td><?php echo $res['c_exp_tb'];?></td>
