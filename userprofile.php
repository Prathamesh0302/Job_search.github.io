...
$sql = "SELECT r_address, r_name, r_contact, r_email FROM companyregister_tb WHERE r_email = '$r_email'";
...
<div class="form-group">
      <label for="r_name">Company Name</label>
   ...
   <div class="form-group">
      ...
      <input type="tel" class="form-control" name="r_contact" id="r_contact" value="<?php echo $r_contact ?>" readonly>
    </div>
    <div class="form-group">
