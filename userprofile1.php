...
<nav class="navbar navbar-dark fixed-top bg-danger flex-md-nowrap p-0 shadow"><a class="navbar-brand col-sm-3 col-md-2 mr-0" href="userprofile1.php">Job Search</a></nav>
...
<form action="" method="POST" class="ms">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="m_contact" id="m_contact" value="<?php echo $m_contact ?>" readonly>
    </div>
    <div class="form-group">
